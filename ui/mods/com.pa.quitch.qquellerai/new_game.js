...
function qQuellerAI() {
    ...
    var newPersonalities = {
        ...
        'Q-Uber Old Aggressive': {
            display_name: '!LOC:Q-Uber Old Aggressive',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Air': {
            display_name: '!LOC:Q-Uber Old Air',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Bot': {
            display_name: '!LOC:Q-Uber Old Bot',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Free For All': {
            display_name: '!LOC:Q-Uber Old Free For All',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Naval': {
            display_name: '!LOC:Q-Uber Old Naval',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Orbital': {
            display_name: '!LOC:Q-Uber Old Orbital',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Rush': {
            display_name: '!LOC:Q-Uber Old Rush',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
        ...
        'Q-Uber Old Tank': {
            display_name: '!LOC:Q-Uber Old Tank',
            metal_drain_check: 0.54,
            energy_drain_check: 0.65,
            metal_demand_check: 0.85,
            energy_demand_check: 0.8,
    ...
    _.defer(function () {
        model.localChatMessage(loc("!LOC:Queller AI"), loc("!LOC:by Quitch. Version 4.37.0. My difficulties are prefixed with a Q.  Don't make AI teams larger than human teams, increase the difficulty or the econ rate instead. I support the Legion Expansion."));
    });
