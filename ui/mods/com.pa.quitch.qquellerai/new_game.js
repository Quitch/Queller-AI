...
function qQuellerAI() {
  ...
  var newPersonalities = {
    "Q-Casual": {
      ...
      personality_tags: ["queller", "casual"],
    ...
    "Q-Bronze": {
      ...
      personality_tags: ["queller", "bronze"],
      min_basic_fabbers: 5,
      min_advanced_fabbers: 3
    },
    "Q-Silver": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "silver"],
      min_basic_fabbers: 4,
      min_advanced_fabbers: 3
    },
    "Q-Gold": {
    ...
    "Q-Platinum": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "platinum"],
      min_basic_fabbers: 2,
      min_advanced_fabbers: 2
    },
    "Q-Uber": {
    ...
    "Q-Uber 1v1": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "1v1", "doublebot", "lateorbital"],
      min_basic_fabbers: 3,
      min_advanced_fabbers: 1
    },
    "Q-Uber Bot": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "bot", "doublebot"],
      min_basic_fabbers: 3,
      min_advanced_fabbers: 1
    },
    "Q-Uber Free For All": {
      ...
      adv_eco_mod: 0.85,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "ffa"],
      min_basic_fabbers: 4,
      min_advanced_fabbers: 1
    },
    "Q-Uber Naval": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "naval"],
      min_basic_fabbers: 1,
      min_advanced_fabbers: 1
    },
    "Q-Uber Rush": {
      ...
      adv_eco_mod: 2.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "doublebot", "lateorbital"],
      min_basic_fabbers: 2,
      min_advanced_fabbers: 1
    },
    "Q-Uber Tank": {
      ...
      adv_eco_mod: 1.0,
      adv_eco_mod_alone: 0,
      personality_tags: ["queller", "uber", "tank"],
      min_basic_fabbers: 3,
      min_advanced_fabbers: 1
    }
  };
  ...
  _.defer(function() {
    model.localChatMessage(
      loc("!LOC:Queller AI"),
      loc(
        "!LOC:by Quitch. Version #.##.#. My difficulties are prefixed with a Q. Don't make AI teams larger than human teams, increase the difficulty or the econ rate instead. I support the Legion Expansion."
      )
    );
  });
}
